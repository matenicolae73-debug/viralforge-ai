...
export default function Home(){
 ...
 return <main className="shell">
  <nav><div className="logo">ViralMovie <span>API</span></div><div className="links"><a href="#campaigns">Campaign Demo</a><a href="#generate">Video AI</a><a href="#keys">API Keys</a><a href="#pricing">Pricing</a></div></nav>
  ...
  <section className="demo-wrap" id="campaigns">
   <div className="demo-card">
    <div className="demo-copy">
     <div className="demo-badge">LIVE DEMO CAMPAIGN · COCA-COLA</div>
     <h2>From idea to a social ad in seconds.</h2>
     <p>See how ViralForge AI can turn a simple product brief into a cinematic campaign concept. This sample campaign was created for demonstration purposes.</p>
     <div className="demo-meta"><span>🎯 Brand awareness</span><span>📱 Social-first</span><span>⏱ 8 sec</span><span>9:16 vertical</span></div>
     <div className="demo-script"><b>Campaign:</b> Share the Spark<br/><b>Hook:</b> Make the moment count.<br/><b>CTA:</b> Share the spark.</div>
     <a className="btn demo-btn" href="#generate">Create your campaign</a>
    </div>
    <div className="demo-video">
      <video src="/demo/coca-cola-campaign-demo.mp4" controls playsInline preload="metadata" poster="/demo/coca-cola-campaign-demo-poster.svg"/>
      <div className="demo-caption">Coca-Cola · Concept demonstration · Not an official Coca-Cola campaign</div>
    </div>
   </div>
  </section>
